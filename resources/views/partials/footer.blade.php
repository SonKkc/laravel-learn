    ...
    <div class="footer__container">
        ...
        <div class="footer__bottom">
            <nav class="footer__nav" aria-label="Footer">
                <a class="footer__nav-item" href="/">Home</a>
                <a class="footer__nav-item" href="/about">About us</a>
                <a class="footer__nav-item" href="/contact">Contact us</a>
                <a class="footer__nav-item" href="/privacy">Privacy policy</a>
                <a class="footer__nav-item" href="/privacy">Terms &amp; Conditions</a>
            </nav>
