<div x-show="confirmOpen" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 z-10 max-w-md w-full">
        ...
        <p class="text-sm text-gray-600 mb-4">Are you sure you want to perform this action on the product?</p>
        <div class="flex items-center justify-end gap-2">
            <button x-on:click.prevent="confirmOpen=false" class="px-4 py-2 rounded border">Cancel</button>
