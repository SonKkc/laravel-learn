    ...
    <div class="w-full max-w-md rounded-2xl bg-white shadow-xl p-8 border border-gray-100">
        ...
        <form method="POST" action="{{ route('reset.post') }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="email" type="email" name="email" required autocomplete="email" value="{{ $email ?? old('email') }}"
            ...
            <button type="submit" class="w-full rounded-full bg-main-red hover:bg-main-red-hover transition text-white font-bold py-2.5 mt-2 shadow-lg text-lg tracking-wide focus:outline-none focus:ring-2 focus:ring-main-red/30">Đặt lại mật khẩu</button>
        </form>
